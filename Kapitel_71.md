...
- der Logik der Kreisläufe  
- der Logik der Reproduktion  
- der Logik der Rückführung  
- der Logik der Kopplung  

Die Natur ist stabil, weil sie die Ordnung der Welt nicht verlässt.

## 2. Die Natur bindet Energie effizient

Die Natur verschwendet keine Energie.  
Sie bindet sie.

- Pflanzen verwandeln Sonnenlicht in Biomasse  
- Ökosysteme verwandeln Biomasse in Nahrungsketten  
- Böden verwandeln organisches Material in Nährstoffe  
- Wasserzyklen verwandeln Wärme in Bewegung  
...
## 3. Die Natur schließt Kreisläufe vollständig

In der Natur gibt es keinen Abfall.  
Alles, was entsteht, wird wieder Teil des Systems.

- Was stirbt, wird Nahrung  
- Was zerfällt, wird Boden  
- Was wächst, wird Energie  
- Was verbraucht wird, kehrt zurück  
...
## 5. Die Natur führt alles zurück

Rückführung ist das unsichtbare Gesetz der Natur.

- Nährstoffe kehren in den Boden zurück  
- Wasser kehrt in den Kreislauf zurück  
- Energie kehrt in neue Strukturen zurück  
- Organismen kehren in das System zurück, das sie hervorgebracht hat  
...
## 6. Die Natur koppelt Systeme miteinander

In der Natur ist alles verbunden:

- Pflanzen mit Böden  
- Böden mit Mikroorganismen  
- Mikroorganismen mit Tieren  
- Tiere mit Pflanzen  
- Wasser mit Klima  
- Klima mit Energieflüssen  
...
## 7. Die Natur passt sich an — ohne ihre Ordnung zu verlieren
...
## 8. Die Natur ist das Referenzsystem des Systemischen Realismus

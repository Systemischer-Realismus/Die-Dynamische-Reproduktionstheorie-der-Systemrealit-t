...
- ein verlässliches System kann sich verändern  
- ohne unvorhersehbar zu werden  
...
- schaffen Transparenz, damit Erwartungen klar werden  
- gestalten Verlässlichkeit, indem sie Muster nicht abrupt brechen  
- nutzen Bindung als Ressource, nicht als Fessel  
- machen Unsicherheit tragfähig, statt sie zu vermeiden  
...
- brechen Muster, ohne es zu merken  
- erzeugen Erwartungen, die sie nicht erfüllen können  
- verwechseln Bindung mit Kontrolle  
- verwechseln Vertrauen mit Naivität  
...
- Bindung schafft Dauer  

## 7. Systemischer Realismus

Systemischer Realismus erkennt:

- Ein System lebt nicht durch Kontrolle, sondern durch Vertrauen, das Wirkung ermöglicht  
- Nicht durch starre Verlässlichkeit, sondern durch Verlässlichkeit, die Wandel trägt  
- Nicht durch Bindung als Abhängigkeit, sondern durch Bindung als gegenseitige Stabilisierung  

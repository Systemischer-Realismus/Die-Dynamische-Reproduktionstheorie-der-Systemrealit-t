...
2. Ökologische Systeme – Stabilität durch vollständige Kreisläufe
Ökologische Systeme sind die klarsten Beispiele funktionierender Ordnung.
Sie sind stabil, weil sie:
- Energie effizient binden
- Stoffe vollständig zurückführen
- Reproduktion ununterbrochen ermöglichen
- Arten und Prozesse koppeln
- Anpassung zulassen
Wenn ökologische Systeme instabil werden, liegt es fast immer daran,
dass Kreisläufe unterbrochen wurden:
- Böden verlieren Nährstoffe
- Wasser wird verschmutzt
- Arten sterben aus
- Energieflüsse werden gestört
Ökologische Instabilität ist Reproduktionsverlust.

3. Soziale Systeme – Stabilität durch Vertrauen und Rückführung
...
- Vertrauen nicht erneuert wird
- Verantwortung nicht zurückkehrt
- Anerkennung ausbleibt
- Beziehungen entkoppelt werden
Soziale Instabilität ist Verlust von Rückführung.

4. Kulturelle Systeme – Stabilität durch Weitergabe
...
- Traditionen abbrechen
- Werte nicht erneuert werden
- Identität fragmentiert
Kulturelle Instabilität ist Verlust von Reproduktion.

5. Institutionelle Systeme – Stabilität durch Kopplung
Institutionen sind stabil, wenn sie:
- mit der Realität gekoppelt sind
- mit den Menschen gekoppelt sind
- mit ihren Aufgaben gekoppelt sind
- mit ihren Rückkopplungen verbunden bleiben
...
6. Wirtschaftliche Systeme – Stabilität durch Rückführung von Mehrwert

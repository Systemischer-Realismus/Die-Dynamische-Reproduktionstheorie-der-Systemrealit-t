...
## 3. Systemische Handlungsfähigkeit als emergente Form von Selbstwirksamkeit
...
## 4. Die handlungsorientierte Praxis stabiler Systeme

Stabile Systeme pflegen Orientierung.  
Sie:

- klären ihre Ziele, ohne sie zu verabsolutieren  
- erkennen relevante Muster und ignorieren Lärm  
- navigieren mit kleinen, reversiblen Schritten  
- vermeiden große, riskante Sprünge  

Ihre Handlungsfähigkeit entsteht aus Klarheit —  
nicht aus Geschwindigkeit.

## 5. Die Orientierungslosigkeit instabiler Systeme

Instabile Systeme verlieren Orientierung.  
Sie:

- reagieren impulsiv oder gar nicht  
- verwechseln Aktivität mit Navigation  
- verwechseln Information mit Orientierung  
- treffen Entscheidungen, die nicht anschlussfähig sind  
- vermeiden Entscheidungen, bis die Umwelt sie erzwingt  

So wird Unsicherheit zur Lähmung —  
und Handlungsfähigkeit zerfällt.

## 6. Die operative Zukunftsordnung des Systems

Orientierung, Navigation und systemische Handlungsfähigkeit bilden die operative Zukunftsordnung eines Systems.

- Orientierung schafft Richtung  
- Navigation schafft Bewegung  
- Handlungsfähigkeit schafft Wirkung  

## 7. Systemischer Realismus

Systemischer Realismus erkennt:

- Ein System lebt nicht durch vollständiges Wissen, sondern durch tragfähige Orientierung  
- Nicht durch starre Pläne, sondern durch adaptive Navigation  
- Nicht durch maximale Handlung, sondern durch wirksame Handlung  

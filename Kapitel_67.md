...
- Pflanzen binden Licht  
- Ökosysteme binden Stoffe  
- Gesellschaften binden Wissen  
- Wirtschaften binden Mehrwert  
...
## 3. Kreisläufe führen Stoffe zurück
...
- wir verbrauchen, ohne zu erneuern  
- wir erzeugen „Abfall“, der keiner ist — sondern verlorene Reproduktion  

Ein System, das Stoffe nicht zurückführt, verliert seine Zukunft.

## 4. Kreisläufe erneuern Strukturen
...
## 6. Kreisläufe sind die Grundlage jeder Zukunft

Ein System hat Zukunft, wenn seine Kreisläufe funktionieren:

- wenn Energie gebunden wird  
- wenn Stoffe zurückkehren  
- wenn Reproduktion gesichert ist  
- wenn Mehrwert zurückgeführt wird  

Zukunft ist kein Versprechen.  
Zukunft ist ein Kreislauf.

## 7. Die Logik der Kreisläufe ist die Logik der Welt
